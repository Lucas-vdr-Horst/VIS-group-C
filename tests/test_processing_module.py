...
class Test(TestCase):
    ...
    def test_get_coordinates_lane_engress(self):
        ...
        root = open_xml('BOS210') #ET.parse('../intersections/BOS210/79190154_BOS210_ITF_COMPLETE.xml')
    ...
    #    df = pd.read_csv('paden_autos') #TODO waar refereert dit naar? 
    ...
    def test_get_geoposities(self):
        ...
        root = open_xml('BOS210')
        df = get_all_lanes_coordinates(root)
