...
class Test(TestCase):
    ...
    def test_get_dict_lane_info(self):
        file_name = 'BOS210'
        expected_output = {'07': {'induction_loops': ['011', '012', '013', '014'], 'traffic_light': ''}, '08': {'induction_loops': ['031', '032', '033', '034'], 'traffic_light': ''}, '13': {'induction_loops': ['041', '042', '043', '044'], 'traffic_light': '04'}, '14': {'induction_loops': ['051', '052', '053', '054'], 'traffic_light': '05'}, '01': {'induction_loops': ['111', '112', '113', '114'], 'traffic_light': ''}, '02': {'induction_loops': ['121', '122', '123', '124'], 'traffic_light': ''}, '09': {'induction_loops': ['221', '222', '223'], 'traffic_light': ''}, '03': {'induction_loops': ['241'], 'traffic_light': ''}, '04': {'induction_loops': ['281'], 'traffic_light': ''}, '12': {'induction_loops': ['411', '412'], 'traffic_light': '41'}, '15': {'induction_loops': ['F055'], 'traffic_light': ''}}
